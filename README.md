...
LOCKv2 is actualy LOCKv1 but with some changes and improvements.
be prepered for LOCKv3 the last version of LOCK project :)

--What is LOCKv2 ?
Its a password generator written in python3
It can generate any random password for user based on his/her needs.
just enter how much characters and numbers, and you will see your randomized password.


--What will be in LOCKv3 ?
My last update on this project will be creating a personal password database for your passwords and using a gpg encryption for its security.
